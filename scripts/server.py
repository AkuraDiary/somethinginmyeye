...
try:
    ...
    print(f"⚠️ Model V2 failed to load from {MODEL_PATHS['v2']}. Make sure it exists!")
    model = None
...
if __name__ == '__main__':
    print("🚀 Web server starting at http://0.0.0.0:8000")
    print("   Data Collector: http://localhost:8000/")
    print("   Screening App:  http://localhost:8000/screen")
